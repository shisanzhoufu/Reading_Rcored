...
[![image-20200317114503403]()](https://github.com/smallC-L-Y/Demo/blob/notes/nodeJS学习笔记.md)
...
##### 安装：[![image-20200310123723079]()](https://github.com/smallC-L-Y/Demo/blob/notes/nodeJS学习笔记.md)

```
cnpm install express
```

##### hello world:[![image-20200310124850557]()](https://github.com/smallC-L-Y/Demo/blob/notes/nodeJS学习笔记.md)
...
mongoose.connect('mongodb://localhost/blog', { useNewUrlParser: true, useUnifiedTopology: true },function(err){
  if(err){
    //throw err;
    console.log(err);
  }else{
...
[![image-20200313085008929]()](https://github.com/smallC-L-Y/Demo/blob/notes/nodeJS学习笔记.md)
...
[![image-20200313084746701]()](https://github.com/smallC-L-Y/Demo/blob/notes/nodeJS学习笔记.md)
...
![image-20200518165038215](C:\Users\王春梅\AppData\Roaming\Typora\typora-user-images\image-20200518165038215.png)
